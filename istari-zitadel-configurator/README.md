...
![Version: 1.10.1](https://img.shields.io/badge/Version-1.10.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 8.13.4](https://img.shields.io/badge/AppVersion-8.13.4-informational?style=flat-square)
...
```sh
helm repo add istari-digital https://istaridigital.jfrog.io/artifactory/api/helm/main-helm-local --username <username> --password <token>
helm install istari-zitadel-configurator istari-digital/istari-zitadel-configurator [--values my-values.yaml]
```
