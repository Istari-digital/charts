...
| identityService.identityRouterClientRegistration.registryServiceSecretName | string | `"istari-fileservice"` | Secret name for `FILE_SERVICE_IDENTITY_ROUTER_SECRET` (must contain the registry-service identity-router client credential). |
