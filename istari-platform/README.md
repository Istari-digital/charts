...
![Version: 3.4.3](https://img.shields.io/badge/Version-3.4.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 6.x.x](https://img.shields.io/badge/AppVersion-6.x.x-informational?style=flat-square)
...
| docs.tag | string | `"6.9.2"` | Image tag. The combination of registry, image, and tag will be used to pull the image. |
...
| fileservice.tag | string | `"10.11.0"` | Image tag. The combination of registry, image, and tag will be used to pull the image. |
