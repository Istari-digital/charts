...
![Version: 3.19.2](https://img.shields.io/badge/Version-3.19.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 10.x.x](https://img.shields.io/badge/AppVersion-10.x.x-informational?style=flat-square)
...
| docs.tag | string | `"6.14.1"` | Image tag. The combination of registry, image, and tag will be used to pull the image. |
...
| fileservice.tag | string | `"10.21.2"` | Image tag. The combination of registry, image, and tag will be used to pull the image. |
...
| secureConnection.tag | string | `"10.21.2"` | Image tag. The combination of registry, image, and tag will be used to pull the image. |
